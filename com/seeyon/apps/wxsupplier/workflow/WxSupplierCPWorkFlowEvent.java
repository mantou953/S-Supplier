 ...
 * 产品检验合格进仓单
 */
public class WxSupplierCPWorkFlowEvent extends AbstractWorkflowEvent {
	...
	public String getId() {
		return AppContext.getSystemProperty("wxsupplier.cpWorkFlowEventId");
	}

	public String getLabel() {
		return AppContext.getSystemProperty("wxsupplier.cpWorkFlowEventLabel");
	}
