...
/**
 * @ClassName WxSupplierNewCPWorkFlowEvent
 * @Description 添加新产品合格进仓单
 * @Author 余洁
 * @Date 2022/1/12 8:54
 * @Version
 */
public class WxSupplierNewCPWorkFlowEvent extends AbstractWorkflowEvent {
    ...
    public String getId() {
        return AppContext.getSystemProperty("wxsupplier.newCpWorkFlowEventId");
    }

    public String getLabel() {
        return AppContext.getSystemProperty("wxsupplier.newCpWorkFlowEventLabel");
    }
