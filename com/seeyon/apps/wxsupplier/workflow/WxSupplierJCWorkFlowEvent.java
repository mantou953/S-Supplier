 ...
 * 进仓单（产品型号调整单）
 */
public class WxSupplierJCWorkFlowEvent extends AbstractWorkflowEvent {
	...
	public String getId() {
		return AppContext.getSystemProperty("wxsupplier.jcWorkFlowEventId");
	}

	public String getLabel() {
		return AppContext.getSystemProperty("wxsupplier.jcWorkFlowEventLabel");
	}
