 ...
 * 破损调数单
 */
public class WxSupplierPSWorkFlowEvent extends AbstractWorkflowEvent {
	...
	public String getId() {
		return AppContext.getSystemProperty("wxsupplier.psWorkFlowEventId");
	}

	public String getLabel() {
		return AppContext.getSystemProperty("wxsupplier.psWorkFlowEventLabel");
	}
